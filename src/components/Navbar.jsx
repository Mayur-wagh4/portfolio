...
const Navbar = () => {
  ...
  return (
  <nav className={`${styles.paddingX} w-full flex item-center py-4 fixed top-0 z-20 bg-primary`}>
...
<Link
  ...
  <p className='text-white text -[18px] font-bold cursor-pointer flex'> MAYUR WAGH &nbsp;
